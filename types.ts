...
export interface AppContent {
  ...
  popupTitleSize?: string;
  popupTitleFontFamily?: string;
  popupTitleFontWeight?: string;
  popupTextColor?: string;
  popupTextSize?: string;
  popupTextFontFamily?: string;
  popupTextFontWeight?: string;
  introText: string;
  welcomeText: string;
  ...
  startPageImage?: string; // Legacy field, kept for compatibility
  startPageText?: string;  // Legacy field, kept for compatibility
  startPageTextColor?: string; // Legacy field
  startPageTextSize?: string; // Legacy field
  ...
  authTitleSize?: string; // 'text-2xl', 'text-3xl', 'text-4xl'
  // Typography controls
  textFontFamily?: string;
  textFontWeight?: string;

  startPageFontFamily?: string;
  startPageFontWeight?: string;

  grabPageFontFamily?: string;
  grabPageFontWeight?: string;

  authTitleFontFamily?: string;
  authTitleFontWeight?: string;
...
export interface User {
  ...
  customOrderLoadingTime?: number; // New field for loading duration
}
...
// New Product Interface for Catalog
